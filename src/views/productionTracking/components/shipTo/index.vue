<template>
    <MyContainer>
        <MyAction @on-reset="onReset" @on-search="onSearch">
            <MyButton :btn="'not'" title="ShipTo" :disabled="multiple.length!=1" @click="hadnleInfo('shipTo')"></MyButton>
    ...
    export default {
        ...
        setup(props, ctx) {
            ...
            const {
                ...
                apiResponse,
                pageChange
            } = useList(ctx,'productionTracking/shipTo');
            ...
            const hadnleInfo = (type) => {
                ...
                switch (type) {
                    ...
                    case 'history':
                        ...
                        break;
                    case 'shipTo':
                        handleRoute({type, open: 'handleShipTo', close: 'handleShipTo',data:multiple.value[0]});
                        break;
                }
            };
